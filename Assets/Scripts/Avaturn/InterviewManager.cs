...
public class InterviewManager : MonoBehaviour
{
    ...
    [Tooltip("Drag the Avaturn Model (with Animator) here")]
    ...
    {
        if (interviewerAnimator != null && ttsSpeaker != null)
        {
           
            bool isSpeaking = ttsSpeaker.IsSpeaking;
            interviewerAnimator.SetBool("IsTalking", isSpeaking);
        }
    }
    ...
    void StartListening()
    {
        ...
        if (groqApiClient != null)
        {
            groqApiClient.CancelPendingRequests();
        }
